...
class HelloWorldApi(remote.Service):
    """Helloworld API v1."""
    #request class = message_types.VoidMessage, response class = Hello
    ...
    @endpoints.method(REQUEST_GREETING_CONTAINER, Hello, path = "greetByPeriod", http_method='GET', name = "greetByPeriod")
